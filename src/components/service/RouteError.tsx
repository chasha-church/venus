...
export const RouteError: React.FC<RouteErrorProps> = ({}) => {
    ...
    return (
        <div>
            ...
            <StyledBlockQuote>
                <p>Мы редко думаем о том, что имеем, но всегда беспокоимся о том, чего у нас нет.</p>
                <cite>Артур Шопенгауэр</cite>
            </StyledBlockQuote>

            <StyledBlockQuote>
                <p>Свобода ничего не стоит, если она не включает в себя свободу ошибаться.</p>
